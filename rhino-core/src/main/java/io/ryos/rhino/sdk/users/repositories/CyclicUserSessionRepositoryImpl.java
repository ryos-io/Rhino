...
/**
 * User define repository provides the user sessions limited by maxNumberOfUsers. The take()
 * method returns the next
 * user define in the backing collection. Once all elements in the collection are returned, the cyclic iterator starts
 * from the beginning.
 * <p>
 *
