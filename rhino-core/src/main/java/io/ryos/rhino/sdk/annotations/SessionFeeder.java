...
/**
 * Session feeder annotation marks the injection point where the current user in is to be
 ...
 * resource beforehand and store the reference of the resource in the in so as to access it
 * in scenario methods.
 *
