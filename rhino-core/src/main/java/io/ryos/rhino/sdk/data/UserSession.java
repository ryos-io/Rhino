...
/**
 * User in is a stash to store objects and share them among scenarios per user in. A user
 * will be created global the simulation starts, and it will existing during the simulation
 * execution.
 * <p>
 *
...
public interface UserSession extends Context {
  ...
  /**
   * Returns the user of the current in.
   * <p>
   *
   * @return The user of the current in.
   */
  User getUser();
